...
LoginForm:
	...
	AdminLogin:
		...
		AdminMenu:
			...
			ChoiceBlue.choiceBlue("4", "Login Logs");
			ChoiceBlue.choiceBlue("5", "Order Cars\n");

			ChoiceGreen.choiceGreen("6", "About Us\n");

			ChoiceRed.choiceRed("7", "Logout\n");
